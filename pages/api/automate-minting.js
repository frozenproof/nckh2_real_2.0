...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var koiosProvider, recipentAddress, utxos, test_names, imageAddress, test_types, appWallet, costLovelace, selectedUtxos, tx, AppWalletAddress, forgingScript, i, assetName, assetMetadata, targetedNFTasset, _unsignedTx, unsignedTx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    test_types = req.body.test_types;
